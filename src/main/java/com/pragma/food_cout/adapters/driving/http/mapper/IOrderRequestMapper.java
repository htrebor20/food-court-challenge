...
public interface IOrderRequestMapper {
    ...
    List<OrderResponseDto> toResponseOrderList(List<Order> orderCustomPage);

    CustomPage<OrderResponseDto> toResponseDtoList(CustomPage<Order> customPage);
    default CustomPage<OrderResponseDto> toCustomPage(CustomPage<Order> orderPage) {
